...
catMap = {'테이블': 50001235, 'TV거실장': 50001310, '소파': 50001234, '장식장': 50001311, '사무/교구용가구': 50001240, '의자': 50001239, '책상': 50001238, '책장': 50001346,
            ...
            '옷장': 50003227, '행거': 50001319, '접이식테이블': 50003254}
...
router.post('/select', async (req, res) => {
    ...
    cat = json_body['cat'];
    color = json_body['color']; //배열
    minPrice = json_body['min_price'];
    maxPrice = json_body['max_price'];
    brand = json_body['brand'];//배열
    spec = json_body['spec'];//종류, 배열
    spec2 = json_body['spec2'];

    var url = await choice(cat, color, brand, minPrice, maxPrice, spec, spec2);
